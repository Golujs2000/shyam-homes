      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 text-left space-y-6">
            {/* Small Label */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 border border-primary-300 backdrop-blur-md shadow-sm">
              <span className="w-2 h-2 rounded-full bg-primary-500 animate-pulse" />
              <span className="text-[11px] md:text-xs font-bold tracking-wider uppercase text-yellow-800">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-gunmetal-900 tracking-tight leading-[1.15]">
              ...
              <span className="text-gunmetal-800 italic font-semibold">Patna</span>
            </h1>

            {/* Highlight */}
            <div className="flex items-center gap-3 text-gunmetal-900 font-semibold text-lg md:text-xl tracking-wide">
              <span className="bg-primary-100/90 px-3.5 py-1 rounded-md border border-primary-300 shadow-sm font-bold text-gunmetal-900">
                Buy • Sell • Rent
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-primary-500 hover:bg-primary-400 text-gunmetal-950 font-bold px-7 py-3.5 rounded-xl shadow-md hover:shadow-primary-glow hover:-translate-y-0.5 active:translate-y-0 transition-all text-base group"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-white hover:bg-slate-50 text-gunmetal-900 font-semibold px-7 py-3.5 rounded-xl border border-slate-200 hover:border-primary-400 backdrop-blur-md shadow-sm hover:-translate-y-0.5 active:translate-y-0 transition-all text-base"
              >
          ...
          <div className="hidden lg:flex lg:col-span-4 justify-end">
            <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl border border-lightblue-200 shadow-xl space-y-4 max-w-xs text-left">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-primary-100 border border-primary-200 flex items-center justify-center text-yellow-800">
              ...
              <div className="pt-2 border-t border-lightblue-100 flex items-center justify-between text-xs text-slate-500">
                <span className="flex items-center gap-1">
                  <MapPin className="w-3.5 h-3.5 text-yellow-700" /> Patna, Bihar
                </span>
                <span className="text-yellow-800 font-bold">100% Free Consultation</span>
              </div>
            </div>
          </div>
        </div>
