      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-[#e8f6f9] via-[#d6eff5] to-[#c3e7f1]/50 rounded-3xl border border-lightblue-200 text-gunmetal-900 overflow-hidden shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 p-5 sm:p-10 lg:p-14 bg-[#c3e7f1]/30 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-lightblue-200 text-left">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-moonstone-700 text-xs font-bold uppercase tracking-wider border border-lightblue-300 shadow-sm">
                  Seller Desk
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-lightblue-200">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-moonstone-600 shrink-0 mt-0.5" />
                    <div>
              ...
              {/* Direct Call Strip */}
              <div className="mt-8 pt-6 border-t border-lightblue-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <span className="text-xs text-slate-500 uppercase tracking-wider block">Direct Line</span>
                  <a href="tel:7858832545" className="text-xl font-serif font-bold text-moonstone-700 hover:underline">
                    Call: 7858832545
                  </a>
                </div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-gunmetal-900 px-4 py-2.5 rounded-xl text-xs font-bold border border-lightblue-300 transition-colors w-full sm:w-auto justify-center shadow-sm"
                >
            ...
            <div className="lg:col-span-7 p-5 sm:p-10 lg:p-14 text-left bg-white">
              <div className="max-w-xl mx-auto">
                ...
                {submitted ? (
                  <div className="p-6 rounded-2xl bg-lightblue-100 border border-lightblue-300 text-center space-y-3">
                    <CheckCircle2 className="w-12 h-12 text-moonstone-600 mx-auto" />
                    ...
                    <button
                      ...
                      className="mt-4 px-5 py-2 rounded-xl bg-moonstone-500 text-xs font-bold text-white hover:bg-moonstone-600 shadow-sm"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-gunmetal-900 placeholder-slate-400 focus:outline-none focus:border-moonstone-500 focus:ring-1 focus:ring-moonstone-500"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-gunmetal-900 focus:outline-none focus:border-moonstone-500 focus:ring-1 focus:ring-moonstone-500 cursor-pointer"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-gunmetal-900 placeholder-slate-400 focus:outline-none focus:border-moonstone-500 focus:ring-1 focus:ring-moonstone-500 resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center gap-2 bg-moonstone-500 hover:bg-moonstone-600 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-md hover:-translate-y-0.5 active:translate-y-0"
                    >
